...
<link href="css/style.css" rel="stylesheet" type="text/css" />
	<script src="jquery-1.31.2..min.js"></script>
	<script>
		$(function () {
...
<div class="usBox">
	<div class="usBox_2 clearfix">
		...
		<form action="${pageContext.request.contextPath}/qiantai/userservlet" method="post" name="formUser" onsubmit="checkForm()" >
			...
			<table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3">
				<tr>
					...
					<td width="89%">
						...
						<span id="query_notice" style="color:#FF0000"> </span>
					</td>
				</tr>
				<tr>
